...
const TermsAndConditions = () => {
  return (
    <>
      ...
      <p>
        The caring app stores and processes personal data that you have provided
        ...
        features and it could mean that the caring app won’t work properly or at
        all.
      </p>
      <p>
      ...
      <p>
        You should be aware that there are certain things that caringio will not
        ...
        or provided by your mobile network provider, but caringio cannot take
      ...
      <p>
        Along the same lines, caringio cannot always take responsibility for the
        ...
        the Service, caringio cannot accept responsibility.
      </p>
      <p>
        With respect to caringio’s responsibility for your use of the app, when
        ...
        it available to you. caringio accepts no liability for any loss, direct
      ...
      <p>
        ...
        to keep using the app. caringio does not promise that it will always
      ...
      <h2 id="changes-to-this-terms-and-conditions">
      ...
      <p>These terms and conditions are effective as of 2023-08-21.</p>
      <h2 id="contact-us">Contact Us</h2>
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at admin@caringio.in.
      </p>
      <p>
