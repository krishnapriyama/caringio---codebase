...
const PrivacyPolicy = () => {
  return (
    <>
      <body>
        <h1 style={{ margin: "0px auto 8px auto" }}>Privacy Policy</h1>
        <p style={{ margin: "0px auto 8px auto" }}>
          ...
          related to it, still belong to caringio.
        </p>

        <p style={{ margin: "0px auto 8px auto" }}>
          Caringio is committed to ensuring that the app is as useful and
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          The caring app stores and processes personal data that you have
          ...
          security features and it could mean that the caring app won’t work
          properly or at all.
        </p>
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          You should be aware that there are certain things that caringio will
          ...
          Wi-Fi or provided by your mobile network provider, but caringio cannot
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          Along the same lines, caringio cannot always take responsibility for
          ...
          avail the Service, caringio cannot accept responsibility.
        </p>

        <p style={{ margin: "0px auto 8px auto" }}>
          With respect to caringio’s responsibility for your use of the app,
          ...
          that we can make it available to you. Caringio accepts no liability
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          ...
          you want to keep using the app. Caringio does not promise that it will
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          Your privacy is of utmost importance to us. We want to assure you that
          all sensitive data, including email addresses and phone numbers, is
          securely stored in our system. Only you, the user, have access to this
          information, and no developer or unauthorized party can access your
          data.
        </p>

        <p style={{ margin: "0px auto 8px auto" }}>
          We understand the importance of your privacy and want to be
          transparent about how we use camera access and Android ID in our
          application. These permissions are utilized solely for enhancing the
          functionality of our app in a secure and responsible manner. We want
          to assure you that your data will not be misused in any circumstance.
        </p>

        <p style={{ margin: "0px auto 8px auto" }}>
          Collection of various types of user information, their purposes, and
          the commitment to data security and responsible handling for the sole
          purpose of application functionality.
        </p>

        <h2 style={{ margin: "12px auto 8px auto" }}>
          Personal Information We Collect
        </h2>
        <p style={{ margin: "0px auto 8px auto" }}>
          User information like EmailId, address, Contact information, academic
          information etc is being collected and solely used for the purpose of
          providing the core functionality of our application only.
        </p>
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          At CARINGIO, we consider the information we collect from our customers
          to be a vital aspect of our business. We want to make it clear that we
          are not in the business of selling our customers' personal information
          to others and will strictly take care of data privacy.
        </p>
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          Caringio conveys the commitment in protecting user information and
          maintaining a secure environment for storing the user information.
          Whole data is securely stored in private and firewall-protected
          database systems.
        </p>
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          We don’t provide Offerings for usage by children. If you’re under 18,
          you may use the application only with the involvement of a parent or
          guardian.
        </p>
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          ...
          application, for as long as it is required in order to fulfil the
          relevant purposes described in this Privacy Notice, may be required as
          communicated to you. How long we retain specific personal information
          varies depending on the purpose for its use, and personal information
          will be erased in accordance with proper functioning of application.
        </p>
        <h4 style={{ margin: "18px auto 8px auto" }}>
        ...
        <p style={{ margin: "0px auto 8px auto" }}>
          ...
          this page. These terms and conditions are effective as of 2023-08-21
        </p>
        <h4 style={{ margin: "18px auto 8px auto" }}>Contact Us</h4>
        <p style={{ margin: "0px auto 8px auto" }}>
          If you have any questions or suggestions about our Terms and
          Conditions, do not hesitate to contact us at admin@caringio.in. This
